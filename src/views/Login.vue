            ...
            <form class="space-y-6" @submit.prevent = "login">
                <div>
                    ...
                    <div class="mt-2">
                        <input v-model="username" id="username" name="username" type="text" required
                               class="block w-full rounded-md border-0 p-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#3F51B5] sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <router-link to="/modify-pwd" class="font-semibold text-[#3F51B5] hover:text-[#757de8]">忘记密码?</router-link>
                        </div>
                    </div>
                    <div class="mt-2 mb-2">
                        <input v-model="password" id="password" name="password" type="password" autocomplete="current-password" required
                               class="block w-full rounded-md border-0 p-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#3F51B5] sm:text-sm sm:leading-6">
                    </div>
                    <div class="text-sm text-right">
                        <router-link to="/register" class="font-bold text-[#3F51B5] hover:text-[#757de8]">注册</router-link>
                    </div>
                </div>
