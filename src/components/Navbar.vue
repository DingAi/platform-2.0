    ...
    <nav class="top-0 z-50 sticky bg-gray-900 shadow py-4 text-white shadow-lg" v-if="showNavbar">
        <div class="flex justify-between items-center border-green-100 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div class="flex items-center">
                <router-link to="/" class="font-bold text-green-500 text-xl">Platfrom</router-link>
            </div>
            <div class="flex items-center">
                <router-link to="/" class="hover:bg-gray-700 mx-2 px-4 py-2 rounded-md"
                             :class="{ 'bg-gray-700 text-green-500': $route.path === '/' }">Home
                </router-link>
                <router-link to="/history" class="hover:bg-gray-700 mx-2 px-4 py-2 rounded-md"
                             :class="{ 'bg-gray-700 text-green-500': $route.path === '/history' }">历史
                </router-link>
                <router-link to="/analysis" class="hover:bg-gray-700 mx-2 px-4 py-2 rounded-md"
                             :class="{ 'bg-gray-700 text-green-500': $route.path === '/analysis' }">数据分析
                </router-link>
                <router-link to="/download" class="hover:bg-gray-700 mx-2 px-4 py-2 rounded-md"
                             :class="{ 'bg-gray-700 text-green-500': $route.path === '/download' }">数据下载
                </router-link>
            ...
            <div class="relative mx-2" @mouseenter="handleAvatarMouseEnter" @mouseleave="handleAvatarMouseLeave">
                <img @click="toggleUserMenu" src="@/assets/vue.svg" alt="User Avatar"
                ...
                <div v-if="showUserMenu"
                    ...
                    <router-link to="/init-roll" class="block hover:bg-gray-700 px-4 py-2 text-white rounded mt-0.5"
                                 :class="{ 'bg-gray-700 text-green-500': $route.path === '/init-roll' }">初始注册
                    </router-link>
                    ...
                    <router-link to="login"
                                 ...
                                 :class="{ 'bg-gray-700 text-green-500': $route.path === '/login' }">登录界面
                    </router-link>
                    <button @click="logout"
                            class="block w-full text-left hover:bg-gray-700 px-4 py-2 text-white rounded mt-0.5">
                        登出
